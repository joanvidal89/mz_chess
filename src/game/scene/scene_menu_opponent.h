#ifndef SCENE_MENU_OPPONENT
#define SCENE_MENU_OPPONENT
...
class SceneMenuOpponent : public MZScene
{
    //------------------------------------------------------------------------------------
    // CONSTRUCTOR & DESTRUCTOR
    //------------------------------------------------------------------------------------
public:
    SceneMenuOpponent(MZDirector *director);
    ~SceneMenuOpponent();
...
private:
    ...
    const char *OPP_NAMES[9] = {
        "", "MR.CHICKEN", "BILLI BOY", "THE SHOWMAN", "SHARON PARKS", "BUCKET KNIGHT", "MS ROBINSON", "OLD MARCUS", "????"};
