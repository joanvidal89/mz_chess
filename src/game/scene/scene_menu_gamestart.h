#ifndef SCENE_MENU_GAMESTART
#define SCENE_MENU_GAMESTART

#include "../mz_struct.h"
#include "mz_scene.h"
#include <future>

class SceneMenuGameStart : public MZScene
{
    //------------------------------------------------------------------------------------
    // CONSTRUCTOR & DESTRUCTOR
    //------------------------------------------------------------------------------------
public:
    SceneMenuGameStart(MZDirector *director);
    ~SceneMenuGameStart();
